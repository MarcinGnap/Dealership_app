...
CREATE TABLE `orders` (
  ...
  `order_custodian_id` int NOT NULL,
  ...
  KEY `order_custodian_id_idx` (`order_custodian_id`),
  ...
  CONSTRAINT `order_custodian_id` FOREIGN KEY (`order_custodian_id`) REFERENCES `workers` (`worker_id`)
